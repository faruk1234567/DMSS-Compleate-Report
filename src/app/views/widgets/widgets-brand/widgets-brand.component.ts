import { AfterContentInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, Input, ElementRef, ViewChild } from '@angular/core';
...
export class WidgetsBrandComponent implements AfterContentInit {
  ...
  constructor(private elementRef : ElementRef, private changeDetectorRef: ChangeDetectorRef,private decimalPipe: DecimalPipe) {
  }

  @ViewChild('ministryWiseIncome') ministryWiseIncomeRef!: ElementRef;
  @Input() serviceCountAndIncomeData?: any;
  @Input() waterBillServiceCountAndIncomeData?: any;
  @Input() tlsServiceCountAndIncomeData?: any;
  @Input() htServiceCountAndIncomeData?: any;
  @Input() certificateServiceCountAndIncomeData?: any;
  @Input() propertyServiceCountAndIncomeData?: any;
  ...
  focus(ministryWiseIncome: string) {
    this.ministryWiseIncomeRef.nativeElement.focus();
  }
}
