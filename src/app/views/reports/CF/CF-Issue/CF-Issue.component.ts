...
@Component({
  selector: 'app-CF-Issue',
  templateUrl: './CF-Issue.component.html',
  styleUrls: ['./CF-Issue.component.scss']
})
export class CFIssueComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.pbService.generateCertificateIssueReport(this.reportParam).subscribe(data => {
      this.fileId = data;
