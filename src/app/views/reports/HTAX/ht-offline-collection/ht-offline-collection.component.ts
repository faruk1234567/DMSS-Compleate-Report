...
@Component({
  selector: 'app-ht-offline-collection',
  templateUrl: './ht-offline-collection.component.html',
  styleUrls: ['./ht-offline-collection.component.scss']
})
export class HtOfflineCollectionComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.htService.generateHTBOfflineCollectionReport(this.reportParam).subscribe(data => {
      this.fileId = data;
