...
@Component({
  selector: 'app-ht-online-collection',
  templateUrl: './ht-online-collection.component.html',
  styleUrls: ['./ht-online-collection.component.scss']
})
export class HtOnlineCollectionComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.htService.generateHTBOnlineCollectionReport(this.reportParam).subscribe(data => {
      this.fileId = data;
