...
@Component({
  selector: 'app-pb-recovery',
  templateUrl: './pb-recovery.component.html',
  styleUrls: ['./pb-recovery.component.scss']
})
export class PBillRecoveryComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.pbService.generatePropertyOnlineCollectionReport(this.reportParam).subscribe(data => {
      this.fileId = data;
