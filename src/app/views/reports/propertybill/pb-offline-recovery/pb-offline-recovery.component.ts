...
@Component({
  selector: 'app-pb-offline-recovery',
  templateUrl: './pb-offline-recovery.component.html',
  styleUrls: ['./pb-offline-recovery.component.scss']
})
export class  PbillRecoveryOfflineComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.pbService.generatePropertyOfflineCollectionReport(this.reportParam).subscribe(data => {
      this.fileId = data;
