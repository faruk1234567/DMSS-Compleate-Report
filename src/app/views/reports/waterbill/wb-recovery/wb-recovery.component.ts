...
@Component({
  selector: 'app-wb-recovery',
  templateUrl: './wb-recovery.component.html',
  styleUrls: ['./wb-recovery.component.scss']
})
export class WbRecoveryComponent implements OnInit{
  ...
  generateReport() {
    ...
    this.wbService.generateWBCollectionReport(this.reportParam).subscribe(data => {
      this.fileId = data;
