...
@Component({
  selector: 'app-wb-offline-recovery',
  templateUrl: './wb-recoveryoffline.component.html',
  styleUrls: ['./wb-recoveryoffline.component.scss']
})
export class WbRecoveryOfflineComponent implements OnInit{
  ...
  generateReport() {
    ...
    this.wbService.generateWBOfflineCollectionReport(this.reportParam).subscribe(data => {
      this.fileId = data;
