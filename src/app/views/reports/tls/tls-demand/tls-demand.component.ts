...
@Component({
  selector: 'app-tls-demand',
  templateUrl: './tls-demand.component.html',
  styleUrls: ['./tls-demand.component.scss']
})
export class TlsDemandComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.tlsCollectionService.generateTLSDemandReport(this.reportParam).subscribe(data => {
      this.fileId = data;
